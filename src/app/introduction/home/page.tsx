...
export const metadata: Metadata = {
  title: "Home | AutoPBI Documentation",
  description: "Learn about AutoPBI, a desktop application that automates bulk tasks for Power BI workflows.",
};
...
const Home = async () => {
  ...
  const images = Array.from({ length: 5 }, (_, i) => `/introduction/home/${i + 1}.png`);
  ...
  return (
    <Base crumbs={
      ...
      <Carousel className="w-full max-w-2xl mx-auto mb-4 border rounded-md shadow-lg mb-4">
        <CarouselContent>
