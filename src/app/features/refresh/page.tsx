...
export const metadata: Metadata = {
  title: "Bulk Refresh | AutoPBI Documentation",
  description: "Learn how to refresh Power BI datasets in bulk using AutoPBI.",
};
...
const Refresh = async () => {
  ...
  const images = Array.from({ length: 7 }, (_, i) => `/features/refresh/${i + 1}.png`);
