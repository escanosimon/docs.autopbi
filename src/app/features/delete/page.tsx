...
export const metadata: Metadata = {
  title: "Bulk Delete | AutoPBI Documentation",
  description: "Learn how to delete Power BI reports in bulk using AutoPBI.",
};
...
const Delete = async () => {
  ...
  const images = Array.from({ length: 7 }, (_, i) => `/features/delete/${i + 1}.png`);
