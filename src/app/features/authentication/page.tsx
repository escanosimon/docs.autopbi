...
export const metadata: Metadata = {
  title: "Authentication | AutoPBI Documentation",
  description: "Learn how to authenticate with AutoPBI using your Microsoft Power BI account.",
};
...
const Authentication = async () => {
  ...
  // new
  const images = Array.from({ length: 5 }, (_, i) => `/features/authentication/${i + 1}.png`);
