...
export const metadata: Metadata = {
  title: "Adding Features | AutoPBI Documentation",
  description: "Learn how to add new features to AutoPBI following the established patterns and workflows.",
};

const AddingFeatures = async () => {
